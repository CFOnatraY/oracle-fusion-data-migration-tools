...
OUTPUT_LOG = "output_log_patch_tax.csv"
...
def patch_tax_line(tax_line_url):
    body = {"TaxAmount": 0.0}
    r = requests.patch(tax_line_url, json=body, auth=HTTPBasicAuth(USERNAME, PASSWORD), headers=headers)
    ...
    try:
        ...
        for line_id in line_ids:
            ...
            for tax_url in tax_lines:
                status, msg = patch_tax_line(tax_url)
